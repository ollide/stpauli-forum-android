...
public final class Categories {
    ...
    public static final Category OFFIZIELLES = new Category(16, "Offizielles", Forums.CAT_SPORT);
    public static final Category ENGLISH_FORUM = new Category(2, "English Forum", Forums.CAT_SPORT);
    public static final Category SONSTIGES = new Category(3, "Sonstiges", Forums.CAT_SPORT);
