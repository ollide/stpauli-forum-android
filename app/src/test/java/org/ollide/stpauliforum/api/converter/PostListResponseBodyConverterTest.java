...
public class PostListResponseBodyConverterTest {
    ...
    public void testParseQuotesFromMessageWithSingleQuote() throws Exception {
        List<Quote> quotes = converter.parseQuotesFromMessage(Jsoup.parse(MESSAGE_WITH_1_QUOTE));
